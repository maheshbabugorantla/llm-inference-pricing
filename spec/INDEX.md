...
- [x] **M05.5b** — Tier 1 hyperscaler scrapers (AWS, Azure) → `M05.5-hyperscaler-scrapers.md`
...
- [x] **M12** — Public REST API (DRF, catalog + providers + cost-cells endpoints, OpenAPI schema) → uploaded spec
