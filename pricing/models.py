...
class CurrentCostCell(models.Model):
    ...
    provider_slug = models.CharField(max_length=128)
    provider_display_name = models.CharField(max_length=128)
    ...
    class Meta:
        ...
        # Indexes below are created by raw SQL in migrations 0016/0018/0019.
