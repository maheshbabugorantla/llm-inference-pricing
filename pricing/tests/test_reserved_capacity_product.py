...
def test_all_upfront_reserved_capacity_product_saves_cleanly():
    ...
    product.full_clean()
    product.save()
    assert ReservedCapacityProduct.objects.filter(slug="aws-p5-14d-all-upfront").exists()


@pytest.mark.django_db
def test_capacity_block_reserved_capacity_product_saves_cleanly():
    ...
    product.full_clean()
    product.save()
    assert ReservedCapacityProduct.objects.filter(slug="aws-p5-14d-cb").exists()


@pytest.mark.django_db
def test_partial_upfront_reserved_capacity_product_saves_cleanly():
    ...
    product.full_clean()
    product.save()
    assert ReservedCapacityProduct.objects.filter(slug="azure-nd-h100-ri-1yr-partial").exists()


@pytest.mark.django_db
def test_no_upfront_reserved_capacity_product_saves_cleanly():
    ...
    product.full_clean()
    product.save()
    assert ReservedCapacityProduct.objects.filter(slug="gcp-a3-cud-1yr").exists()
...
@pytest.mark.django_db
def test_all_upfront_with_zero_upfront_raises_validation_error():
...
@pytest.mark.django_db
def test_all_upfront_with_nonzero_monthly_raises_validation_error():
...
@pytest.mark.django_db
def test_capacity_block_with_zero_total_raises_validation_error():
...
@pytest.mark.django_db
def test_partial_upfront_with_zero_upfront_raises_validation_error():
...
@pytest.mark.django_db
def test_no_upfront_with_zero_monthly_raises_validation_error():
...
@pytest.mark.django_db
def test_duplicate_reserved_product_slug_raises_integrity_error():
...
@pytest.mark.django_db
def test_reserved_product_str_returns_display_name():
    ...
    assert str(product) == "Lambda Reserved H100 1-yr"


@pytest.mark.django_db
def test_on_demand_reference_usd_is_optional():
    ...
    assert product.on_demand_reference_usd_per_hour is None
